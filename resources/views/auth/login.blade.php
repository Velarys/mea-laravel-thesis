        ...
        <div class="carousel-inner">
            ...
            <div class="item">
             ...
             <div class="item">
                ...
                <div class="fill" style="background-image:url('{{URL::asset('images/4.jpg')}}');"></div>
            </div>
...
<script type="text/javascript" src="{{URL::asset('https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js')}}"></script>
