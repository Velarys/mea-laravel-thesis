...
<div class="row affix-row">
    ...
    <div class="navbar-collapse collapse sidebar-navbar-collapse" >
      <ul class="nav navbar-nav" id="sidenav01">
       ...
       <li><a href="#"><span class="glyphicon glyphicon-pencil"></span> &nbsp;&nbsp;Create Form</a></li>
        ...
        <li class=""><a href="/user"><span class="glyphicon glyphicon-user"></span> &nbsp;&nbsp;View Profile</a></li>
  ...
  <h3><b style="color:#4a89dc">MEA</b> -  Mobile ESAS Applicaiton</h3>
    ...
    <h1><u>Hello, {{Auth::user()->firstname}} {{Auth::user()->lastname}} !</u><br/><br/><small style="font-size:50%; color:#383838;">
